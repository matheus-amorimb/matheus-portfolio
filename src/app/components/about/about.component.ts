  ...
  experiences: Experience[] = [
    {
      ...
      description:
        'Responsável, de forma interdisciplinar com times de automação e otimização, pelo desenvolvimento de uma aplicação que\n' +
        'realiza a otimização de processos industriais utilizando lógica Fuzzy.',
      stacks:
        'Java, Spring Boot, Javascript, Node.js, Angular, Python, PostgreSQL.',
    },
    {
      id: 2,
      company: 'ihm stefanini',
      ...
      description:
        'Responsável pela sustentação da aplicação desenvolvida para a rede de postos Ale encarregada do agendamento dos abastecimentos de combustível de suas unidades.',
